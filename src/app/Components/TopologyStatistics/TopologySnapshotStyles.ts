...
export default {
    ...ApplicationStyles,
    focusedInnerNode: [0, Colors.colors.spectrumPurple, 1, Colors.colors.spectrumDarkPurple],
    unfocusedInnerNode: [0, Colors.colors.spectrumPurple, 1, Colors.colors.spectrumDarkPurple],
    focusedOuttterNode: [0, Colors.colors.spectrumPurple, 1, Colors.colors.spectrumDarkPurple],
    unfocusedOuttterNode: [0, Colors.colors.spectrumPurple, 1, Colors.colors.spectrumDarkPurple],
    toolbarContainer: {
